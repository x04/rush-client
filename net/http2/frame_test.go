...
// test checkFrameOrder and that HEADERS/PUSH_PROMISE and CONTINUATION
// frames can't be intermingled.
...
func testMetaFrame(t *testing.T,
	...
	const flagEndHeaders Flags = 0x4 // same for all end headers flags
